...
void test_insertion_sort_recursive(int A[], const char *case_name) {
    ...
    insertion_sort_recursive(A, size);
...
int main() {
    ...
    test_insertion_sort_recursive(A_average_case, "Average Case");
    test_insertion_sort_recursive(A_best_case, "Best Case");
    test_insertion_sort_recursive(A_worst_case, "Worst Case");
